...
# Determinar la posición de Rocket Raccoon
...
# Determinar la posición de Groot
posicion_groot = None
nombre_groot = "Groot"
for i, personaje in enumerate(pila_mcu.pila[::-1], 1):
...
# Actividad b: determinar los personajes que participaron en más de 5 películas
...
# Actividad c: determinar en cuántas películas participó la Viuda Negra
...
# Actividad d: mostrar todos los personajes cuyos nombres empiezan con C, D y G
